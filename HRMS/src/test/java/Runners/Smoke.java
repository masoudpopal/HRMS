...
@CucumberOptions(
        ...
        monochrome = true,
        tags = "@error",   // to define or filter or scenarios for execution we use tags or to print in groups
        plugin = {"pretty", "html:target/cucumber.html", "json:target/cucumber.json"}  //json is for a colorful report
